...
date: |
  | <br>
  | **10th International Research Forum on Statistical Reasoning, Thinking, & Literacy**
  | Rotorua, New Zealand
  | July 4, 2017
...
- explicitly presents students an elementary abstract model relating sample, population, statistic, & parameter and then  
- prompts the student to assimilate these concepts into a **context of their own invention**. 
...
- **Each group has a random sequence to review** (try to do 3, but continue if there's time)
- **Please make notes in the Google Doc for each student as you review**
    ...
    - devote more attention big picture "stages of development" and "emergent understanding" rather than the nuance of what students attribute to each concept 
