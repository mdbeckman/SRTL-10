...
- Assessment tasks in introductory statistics often present data or context and ask students to do or describe something based on the **provided context**.  
- This study explores an alternative task adapted from Rossman & Chance (2001) [^1] which  
...
- The study data consist of free-text narrative responses from a (inter)national sample  
    - more than total 1600 introductory statistics students participated 
    - a random subset have been reviewed
...
#### Definition
For the purpose of this study, “statistical model” can be understood to mean a statistical approximation designed to extract or explain [describe] the underlying structure of a data generating process (e.g., McCullagh, 2002; Graham, 2006) [^2] [^3]  
...
- Sample characteristics  
    ...
    - 15 institutions  
    - 16 unique courses  
    - 29 total class sections (all except one were from U.S.)  
- Scoring progress to date
...
<!-- whitespace for scrolling content to top of screen in presentation --> 
...
. <!-- scroll anchor for web viewing in presentation -->
...
#### Discussion Notes [(Link)](https://docs.google.com/document/d/1scPx7FBYCHbbO-bMWuNjGOr0GVFyASemOd0wTO26h4U/edit?usp=sharing)
